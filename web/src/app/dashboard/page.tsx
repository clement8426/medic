    ...
    <div style={{ display: 'flex', minHeight: '100vh', background: '#f4f7f8' }}>
      ...
      <main style={{ flex: 1, overflowY: 'auto' }}>
        ...
        <div style={{ padding: '32px' }}>
          <div style={{ fontWeight: 900, fontSize: 12, color: '#09090b', marginBottom: 6, textTransform: 'uppercase', letterSpacing: '0.1em' }}>
            MODULES
          </div>
          ...
          <div style={{
            ...
            {modules.map(mod => {
              ...
              return (
                <div
                  key={mod.id}
                  onClick={() => !comingSoon && router.push(`/module/${mod.slug}`)}
                  style={{
                    background: comingSoon ? '#fafafa' : 'white',
                    borderRadius: 22,
                    border: `1px solid ${comingSoon ? '#e4e4e7' : '#e4e4e7'}`,
                ...
                >
                  ...
                  <div style={{ position: 'absolute', top: 16, right: 16 }}>
                    <span style={{
                      ...
                      background: comingSoon ? '#f4f4f5' : '#f0fdf4',
                      color: comingSoon ? '#a1a1aa' : '#166534',
                      border: `1px solid ${comingSoon ? '#e4e4e7' : '#bbf7d0'}`,
                    }}>
                      {comingSoon ? '⏳ À venir' : `${count} cas`}
                    </span>
                  </div>

                  <div style={{
                    width: 52, height: 52, borderRadius: 16,
                    background: comingSoon ? '#f4f4f5' : 'linear-gradient(135deg,#0F766E22,#0891b222)',
