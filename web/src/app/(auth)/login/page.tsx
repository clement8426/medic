          ...
          {magicSent ? (
            ...
            <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
              ...
              <button type="button" onClick={handleMagicLink} disabled={loading}
                style={{ padding: '14px 0', borderRadius: 16, border: '2px solid #e4e4e7', background: 'white', color: '#52525b', fontWeight: 800, fontSize: 14, cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8 }}>
                <Mail size={16} color="#52525b" strokeWidth={2} /> Lien magique par email
              </button>
            </form>
          )}
        </div>
